        ...
        >
          <Form.Section text={t('通用设置')}>
            <Row gutter={16}>
              ...
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Input
                  field={'ConsoleBackgroundURL'}
                  label={t('控制台背景图地址')}
                  initValue={''}
                  placeholder={t('https://... 或 /xxx.png，留空使用默认背景')}
                  onChange={handleFieldChange('ConsoleBackgroundURL')}
                  showClear
                  extraText={t(
                    '自定义登录后控制台的背景图片，支持 http(s) 链接或站内路径，清空则恢复默认',
                  )}
                />
              </Col>
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
